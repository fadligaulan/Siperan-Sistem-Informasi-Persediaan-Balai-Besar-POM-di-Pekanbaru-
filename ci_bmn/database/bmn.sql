...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Feb 2020 pada 05.17
...
INSERT INTO `barang_masuk` (`id_barang_masuk`, `id_barang`, `jumlah_barang`, `tgl_masuk`, `satuan`, `keterangan`) VALUES
(1, 12, 400, '2020-02-24', 'PCS', 'Pengambilan'),
(2, 15, 800, '2020-02-25', 'PCS', 'Pembelian');
...
CREATE TABLE `gudang` (
  `id_gudang` int(12) NOT NULL,
  `no_gudang` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `stock_barang` (
  ...
  `no_katalog` varchar(200) NOT NULL,
...
INSERT INTO `stock_barang` (`id_barang`, `nama_barang`, `no_katalog`, `stock_barang`, `tgl_kadaluarsa`, `satuan`) VALUES
(12, 'Buku', '123', 190, '2020-02-24', 'PCS'),
(15, 'Kertas', '234', 190, '2020-02-24', 'PCS123');
...
--
ALTER TABLE `gudang`
  MODIFY `id_gudang` int(12) NOT NULL AUTO_INCREMENT;
