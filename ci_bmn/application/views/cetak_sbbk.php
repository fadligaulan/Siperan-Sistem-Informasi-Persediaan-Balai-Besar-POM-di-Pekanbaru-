...
<table width="100%">
    <tr>
        <td width=100 align="center"><strong><u>SURAT BUKTI BARANG KELUAR
                    (SBBK)</u></strong><br>Nomor:<?php echo str_pad($order['no_order'], 2, '0', STR_PAD_LEFT); ?>/SBBK/<?php echo $order['kode_bidang']; ?>/<?php echo $order['bulan']; ?>/<?php echo $order['tahun']; ?>
            </center>
        </td>
    </tr>
</table>
<table width="100%">
    <tr>
        <td width=100 align="left"> Bidang: <?php echo $order['nama_bidang']; ?><br>
